...
export default class BodyDesktop_3 extends Component {
  render() {
    ...
    return (
      <div
        id="Espaços"
        className="ContainerDesktop_3 w-full flex flex-col justify-evenly bg-slate-400 overflow-hidden text-white"
      >
        ...
        <div className="flex flex-col items-center container-interessou-btn">
          ...
          >
            <button className="interessou-btn-desk">
              <h2 className="txt-interessou-btn Text-Fonts-Size-Desktop-Version">
                INTERESSOU? CONSULTE VALORES
              </h2>
            </button>
          </a>
        </div>
