...
export default class DobraMobile_6 extends Component {
  render() {
    ...
    return (
      <div
        id="QuemEstaNoP7"
        className="DobraMobile-Container-6 w-full overflow-hidden flex flex-col  justify-around bg-slate-600 text-white"
      >
        <div className="Textos_Mobile-Container6">
          <h1 className="Titulo_Inovação_Mobile6">
            ONDE CRIATIVIDADE E INOVAÇÃO ACONTECEM.
          </h1>
          <p className="Txt_Mobile6">
        ...
        <div className="ScrollSide_AutoMobile-Position">
          ...
          <Slider {...settings}>
            <div className="AutoPlay_Mobile_Style logo42BHMobile"></div>
            <div className="AutoPlay_Mobile_Style logoVidasMobile"></div>
